    ...
    return (
        <Layout pagina={'Total y Confirmar Pedido'}>
            ...
            <form onSubmit={colocarOrden}>
                ...
                <div className="mt-5">
                    <input
                        className={`${comprobarPedido () ?  'bg-indigo-100' : 'bg-indigo-600 hover:bg-indigo-800' }  w-full lg:w-auto px-5 py-2 rounded text-white text-center uppercase font-bold hover:cursor-pointer`}
                        type={'submit'} 
